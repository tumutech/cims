                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    <div class="span3"><br/>
                                      <i class="fa fa-sun-o fa-5x"></i><br/>
                                    </div>
                                    <div class="span8 text-right"><br/>
...
<?php 
	     $testimony_n = mysqli_query($conn,"select * from testimony ")or die(mysqli_error());
		 $testimony_n = mysqli_num_rows($testimony_n);
		 ?>			
                     <div class="span6">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        <div class="huge"><?php echo $testimony_n;?></div>
                                        <div>Testimonies</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
                            <a href="testimonies.php">							  
                                <div class="modal-footer">
                                    <span class="pull-left">Read</span>
                                    <span class="pull-right"><i class="icon-chevron-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>							  
                            </a>
