...
<link rel="shortcut icon" href="images/logo.png" />
	 <div class="span3" id="sidebar">
               ...
               <!--testimonies -->
               <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs5"><i class="icon-chevron-right"></i><i class="icon-play"></i>&nbsp;Testimonies
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs5" class="collapse">						
                            <li class="">
                            <a href="testimony.php"><i class="icon-chevron-right"></i><i class="icon-comment"></i> Add Testimony</a>
                            </li>
						    <li class="">
                            <a href="testimonies.php"><i class="icon-chevron-right"></i><i class="icon-comments"></i> View Testimony </a>
                            </li>
						    </ul>
						</li>
